...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-154949650-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-154949650-1');
    </script>
    <script>
        var _hmt = _hmt || [];
        (function() {
            var hm = document.createElement("script");
            hm.src = "https://hm.baidu.com/hm.js?8e44de1e129363b13cd31b1df7587f58";
